...
public class TushuTypeBeanAdapter extends ArrayAdapter<TypeBean> {

    private int resourceId;
    private int selected_id = -1;
    public TushuTypeBeanAdapter(@NonNull Context context, int resource, List<TypeBean> typeBeanList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(typeBean.getId()==selected_id){
            viewHolder.bkg_view.setBackgroundResource(R.drawable.tushu_btn_press);
        }else {
